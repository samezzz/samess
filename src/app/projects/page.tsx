    ...
    <div className="flex flex-col items-start">
      <div className="flex flex-col gap-y-8 max-w-[900px] mx-auto">
        ...
        <p className={`${main.paragraph} mb-8 md:mb-12`}>
          ...
          throughout my journey, and here are a few that stand out as my
          proudest achievements. Moreover, I&apos;m actively engaged in current
          projects that are shaping up to be significant milestones. Stay tuned
